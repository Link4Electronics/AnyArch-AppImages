...
SHARUN_LINK=${SHARUN_LINK:-https://github.com/Link4Electronics/sharun-C/releases/latest/download/sharun-$APPIMAGE_ARCH}
HOOKSRC=${HOOKSRC:-https://raw.githubusercontent.com/Link4Electronics/AnyArch-AppImages/refs/heads/main/useful-tools/hooks}
...
APPIMAGETOOL_LINK=${APPIMAGETOOL_LINK:-https://github.com/Link4Electronics/appimagetool-C/releases/download/0.3.3/appimagetool-$APPIMAGE_ARCH}
APPIMAGETOOL=${APPIMAGETOOL:-$TMPDIR/appimagetool}

ANYLINUX_LIB=${ANYLINUX_LIB:-1}
ANYLINUX_LIB_SOURCE=${ANYLINUX_LIB_SOURCE:-https://raw.githubusercontent.com/Link4Electronics/AnyArch-AppImages/refs/heads/main/useful-tools/lib/anylinux.c}
GTK_CLASS_FIX=${GTK_CLASS_FIX:-0}
GTK_CLASS_FIX_SOURCE=${GTK_CLASS_FIX_SOURCE:-https://raw.githubusercontent.com/Link4Electronics/AnyArch-AppImages/refs/heads/main/useful-tools/lib/gtk-class-fix.c}
...
_help_msg() {
	cat <<-EOF
	  ...
	  SEE ALSO:
	  sharun  (https://github.com/Link4Electronics/sharun-C)
...
_make_appimage() {
	...
	if ! URUNTIME_LINK="${URUNTIME_LINK:-https://github.com/Link4Electronics/uruntime-C/releases/download/0.6.0/uruntime-appimage-dwarfs-lite-$APPIMAGE_ARCH}" "$APPIMAGETOOL"; then
